...
# Keep phrasings colloquial and varied — short sentences, slang, fragments —
# so the tiny embedding-bag model generalizes beyond exact keywords.
PHRASES: dict[str, list[str]] = {
    "crisis": [
        ...
        "planning to end it",
        "thoughts of self harm again",
        "i give up on everything",
        "take my own life",
        "don't want to wake up tomorrow",
        "life is not worth living",
        "cutting myself feels like the only option",
        "suicidal and alone",
    ],
    "urge": [
        "i have an urge",
        ...
        "driving past my old dealer",
        "everyone at the party is drinking",
        "my mind is bargaining for one drink",
        "hands are shaking need a fix",
        "thinking about picking up again",
        "old friends offered me some",
        "can't stop thinking about using",
        "one won't hurt right",
        "urge surfing is not working",
        "about to throw away my clean time",
        "smell of beer is triggering me",
        "fighting temptation at the store",
        "massive temptation in front of me",
    ],
    "checkIn": [
        "mood check in",
        "how am i feeling",
        ...
        "numb and tired lately",
        "anxious since i woke up",
        "doing okay i guess",
        "great day so far",
        ...
        "record my headspace",
        # distressed-but-safe check-ins teach the crisis boundary:
        # heavy feelings WITHOUT ideation stay here, never crisis.
        "pretty shaky and restless tonight",
        "emotionally exhausted but hanging in there",
        "overwhelmed and crying it out safely",
        "really low and lonely right now",
        "tired of fighting this battle today",
        "stressed beyond belief this week",
        "feeling hopeless about work stuff",
    ],
    "walk": [
        "i went for a walk",
        "log my steps",
        ...
        "biked to work today",
        "stretched and walked the trail",
        "hiked with friends",
        "wandered the neighborhood",
        "did my physical therapy walk",
        "evening walk along the river",
        "moved my body a bit",
        "gym session finished",
        "swam laps this afternoon",
        "raked the yard counts as steps",
    ],
    "gratitude": [
        "i am grateful",
        "thankful for today",
        ...
        "grateful my family showed up",
        "appreciate this quiet moment",
        "thankful for coffee and calm",
        "gratitude list before bed",
        "lucky to have my group",
        "so glad i stayed sober today",
        "grateful the meeting helped",
        "appreciating small wins",
        "blessed with supportive people",
    ...
    "appHelpPet": [
        ...
        "why did my companion rest",
        "how do i earn sparks faster",
        "what feeds my pet",
        "explain the bond meter",
        "does the companion ever die",
        "what are sparks for",
        "energy bar went down why",
        "pet moods meaning",
        "how to name my companion",
        "where does my pet live in the app",
        "companion check-in rewards",
        "what boosts bond level",
        "is low energy bad for my pet",
    ],
    "appHelpSos": [
        "sos notification",
        "how to call 988",
        ...
        "add my sponsor phone",
        "set up sos contacts",
        "where is the sos button",
        "text 988 from the app",
        "change emergency contact",
        "persistent sos alert setup",
        "who gets notified in an emergency",
        "save a help number",
        "test the sos dialer",
        "crisis lifeline info",
    ...
    "appHelpDresser": [
        ...
        "how to equip a hat",
        "buy new look with sparks",
        "locked item needs bond",
        "aura colors explained",
        "swap my jacket",
        "season limited items gone",
        "dress my companion differently",
        "starter presets meaning",
        "jewelry slot options",
        "refund spent sparks",
    ],
    "greeting": [
        "hello",
        ...
        "hello from your favorite human",
        "wake up coach",
        "sup",
    ],
    "unknown": [
